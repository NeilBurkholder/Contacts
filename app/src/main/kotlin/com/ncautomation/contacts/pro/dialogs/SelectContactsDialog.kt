...
import com.ncautomation.contacts.pro.adapters.SelectContactsAdapter
import com.ncautomation.contacts.pro.databinding.DialogSelectContactBinding
...
class SelectContactsDialog(
    ...
    init {
        ...
        if (allowSelectMultiple) {
            builder.setPositiveButton(com.ncautomation.commons.R.string.ok) { dialog, which -> dialogConfirmed() }
        }
        builder.setNegativeButton(com.ncautomation.commons.R.string.cancel, null)
