...
import com.ncautomation.contacts.pro.databinding.ActivityInsertEditContactBinding
...
class InsertOrEditContactActivity : SimpleActivity(), RefreshContactsListener {
    ...
    private fun initFragments() {
        ...
        binding.newContactTmb.setImageDrawable(
            resources.getColoredDrawableWithColor(
                com.ncautomation.commons.R.drawable.ic_add_person_vector,
                getProperTextColor()
            )
        )
    ...
    private fun setupTabs() {
        ...
        contactsFavoritesList.forEachIndexed { index, value ->
            if (config.showTabs and value != 0) {
                binding.insertEditTabsHolder.newTab().setCustomView(com.ncautomation.commons.R.layout.bottom_tablayout_item).apply tab@{
                    customView?.let {
    ...
    private fun getSelectedTabDrawableIds() = arrayOf(
        com.ncautomation.commons.R.drawable.ic_person_vector,
        com.ncautomation.commons.R.drawable.ic_star_vector
    )

    private fun getDeselectedTabDrawableIds() = arrayOf(
        com.ncautomation.commons.R.drawable.ic_person_outline_vector,
