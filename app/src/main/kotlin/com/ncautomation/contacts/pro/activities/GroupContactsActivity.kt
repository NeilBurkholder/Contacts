...
import com.ncautomation.contacts.pro.databinding.ActivityGroupContactsBinding
import com.ncautomation.contacts.pro.dialogs.SelectContactsDialog
...
import com.ncautomation.contacts.pro.helpers.LOCATION_GROUP_CONTACTS
...
class GroupContactsActivity : SimpleActivity(), RemoveFromGroupListener, RefreshContactsListener {
    ...
    override fun onResume() {
        ...
        (binding.groupContactsFab.layoutParams as CoordinatorLayout.LayoutParams).bottomMargin =
            navigationBarHeight + resources.getDimension(com.ncautomation.commons.R.dimen.activity_margin).toInt()
    }
    ...
    private fun sendSMSToGroup() {
        if (groupContacts.isEmpty()) {
            toast(com.ncautomation.commons.R.string.no_contacts_found)
        } else {
