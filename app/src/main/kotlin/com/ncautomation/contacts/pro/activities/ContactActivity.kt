...
import com.ncautomation.commons.helpers.letterBackgroundColors
...
import com.ncautomation.contacts.pro.extensions.shareContacts

abstract class ContactActivity : com.ncautomation.contacts.pro.activities.SimpleActivity() {
    ...
    fun getEmailTypeText(type: Int, label: String): String {
        return if (type == BaseTypes.TYPE_CUSTOM) {
            ...
            getString(
                when (type) {
                    Email.TYPE_HOME -> com.ncautomation.commons.R.string.home
                    Email.TYPE_WORK -> com.ncautomation.commons.R.string.work
                    Email.TYPE_MOBILE -> com.ncautomation.commons.R.string.mobile
                    else -> com.ncautomation.commons.R.string.other
                }
            )
        }
    }
    ...
    fun getAddressTypeText(type: Int, label: String): String {
        return if (type == BaseTypes.TYPE_CUSTOM) {
            ...
            getString(
                when (type) {
                    StructuredPostal.TYPE_HOME -> com.ncautomation.commons.R.string.home
                    StructuredPostal.TYPE_WORK -> com.ncautomation.commons.R.string.work
                    else -> com.ncautomation.commons.R.string.other
                }
            )
        }
    ...
    fun getEventTextId(type: Int) = when (type) {
        Event.TYPE_ANNIVERSARY -> com.ncautomation.commons.R.string.anniversary
        Event.TYPE_BIRTHDAY -> com.ncautomation.commons.R.string.birthday
        else -> com.ncautomation.commons.R.string.other
    }
