...
import com.ncautomation.commons.dialogs.SelectAlarmSoundDialog
...
import com.ncautomation.commons.models.contacts.Email
import com.ncautomation.commons.models.contacts.Event
...
import com.ncautomation.contacts.pro.adapters.AutoCompleteTextViewAdapter
import com.ncautomation.contacts.pro.databinding.*
import com.ncautomation.contacts.pro.dialogs.CustomLabelDialog
import com.ncautomation.contacts.pro.dialogs.ManageVisibleFieldsDialog
import com.ncautomation.contacts.pro.dialogs.MyDatePickerDialog
import com.ncautomation.contacts.pro.dialogs.SelectGroupsDialog
import com.ncautomation.contacts.pro.extensions.config
import com.ncautomation.contacts.pro.extensions.getCachePhotoUri
import com.ncautomation.contacts.pro.extensions.showContactSourcePicker
import com.ncautomation.contacts.pro.helpers.ADD_NEW_CONTACT_NUMBER
import com.ncautomation.contacts.pro.helpers.IS_FROM_SIMPLE_CONTACTS
import com.ncautomation.contacts.pro.helpers.KEY_EMAIL
import com.ncautomation.contacts.pro.helpers.KEY_NAME

class EditContactActivity : com.ncautomation.contacts.pro.activities.ContactActivity() {
    companion object {
    ...
    override fun onBackPressed() {
        if (System.currentTimeMillis() - mLastSavePromptTS > SAVE_DISCARD_PROMPT_INTERVAL && hasContactChanged()) {
            ...
            ConfirmationAdvancedDialog(
                this,
                "",
                com.ncautomation.commons.R.string.save_before_closing,
    ...
    private fun initNumberHolders() {
        ...
        for (i in 0 until numbersCount) {
            ...
            val drawableId = if (isPrimary) {
                com.ncautomation.commons.R.drawable.ic_star_vector
            } else {
                com.ncautomation.commons.R.drawable.ic_star_outline_vector
            }
    ...
    private fun setupRingtone() {
        ...
        if (ringtone?.isEmpty() == true) {
            binding.contactRingtone.text = getString(com.ncautomation.commons.R.string.no_sound)
    ...
    private fun resetContactEvent(contactEvent: TextView, removeContactEventButton: ImageView) {
        contactEvent.apply {
            text = getString(com.ncautomation.commons.R.string.unknown)
            tag = ""
            alpha = 0.5f
        }
    ...
    private fun showNumberTypePicker(numberTypeField: TextView) {
        val items = arrayListOf(
            RadioItem(Phone.TYPE_MOBILE, getString(com.ncautomation.commons.R.string.mobile)),
            RadioItem(Phone.TYPE_HOME, getString(com.ncautomation.commons.R.string.home)),
            RadioItem(Phone.TYPE_WORK, getString(com.ncautomation.commons.R.string.work)),
            RadioItem(Phone.TYPE_MAIN, getString(com.ncautomation.commons.R.string.main_number)),
            RadioItem(Phone.TYPE_FAX_WORK, getString(com.ncautomation.commons.R.string.work_fax)),
            RadioItem(Phone.TYPE_FAX_HOME, getString(com.ncautomation.commons.R.string.home_fax)),
            RadioItem(Phone.TYPE_PAGER, getString(com.ncautomation.commons.R.string.pager)),
            RadioItem(Phone.TYPE_OTHER, getString(com.ncautomation.commons.R.string.other)),
            RadioItem(Phone.TYPE_CUSTOM, getString(com.ncautomation.commons.R.string.custom))
        )
    ...
    private fun showEmailTypePicker(emailTypeField: TextView) {
        val items = arrayListOf(
            RadioItem(CommonDataKinds.Email.TYPE_HOME, getString(com.ncautomation.commons.R.string.home)),
            RadioItem(CommonDataKinds.Email.TYPE_WORK, getString(com.ncautomation.commons.R.string.work)),
            RadioItem(CommonDataKinds.Email.TYPE_MOBILE, getString(com.ncautomation.commons.R.string.mobile)),
            RadioItem(CommonDataKinds.Email.TYPE_OTHER, getString(com.ncautomation.commons.R.string.other)),
            RadioItem(CommonDataKinds.Email.TYPE_CUSTOM, getString(com.ncautomation.commons.R.string.custom))
        )
    ...
    private fun showAddressTypePicker(addressTypeField: TextView) {
        val items = arrayListOf(
            RadioItem(StructuredPostal.TYPE_HOME, getString(com.ncautomation.commons.R.string.home)),
            RadioItem(StructuredPostal.TYPE_WORK, getString(com.ncautomation.commons.R.string.work)),
            RadioItem(StructuredPostal.TYPE_OTHER, getString(com.ncautomation.commons.R.string.other)),
            RadioItem(StructuredPostal.TYPE_CUSTOM, getString(com.ncautomation.commons.R.string.custom))
        )
    ...
    private fun showIMTypePicker(imTypeField: TextView) {
        val items = arrayListOf(
            ...
            RadioItem(Im.PROTOCOL_CUSTOM, getString(com.ncautomation.commons.R.string.custom))
        )
    ...
    private fun showEventTypePicker(eventTypeField: TextView) {
        val items = arrayListOf(
            RadioItem(CommonDataKinds.Event.TYPE_ANNIVERSARY, getString(com.ncautomation.commons.R.string.anniversary)),
            RadioItem(CommonDataKinds.Event.TYPE_BIRTHDAY, getString(com.ncautomation.commons.R.string.birthday)),
            RadioItem(CommonDataKinds.Event.TYPE_OTHER, getString(com.ncautomation.commons.R.string.other))
        )
    ...
    private fun getFilledEvents(): ArrayList<Event> {
        val unknown = getString(com.ncautomation.commons.R.string.unknown)
    ...
    private fun getStarDrawable(on: Boolean) =
        resources.getDrawable(if (on) com.ncautomation.commons.R.drawable.ic_star_vector else com.ncautomation.commons.R.drawable.ic_star_outline_vector)

    private fun trySetPhoto() {
        val items = arrayListOf(
            RadioItem(TAKE_PHOTO, getString(com.ncautomation.commons.R.string.take_photo)),
            RadioItem(CHOOSE_PHOTO, getString(com.ncautomation.commons.R.string.choose_photo))
        )
    ...
    private fun getPhoneNumberTypeId(value: String) = when (value) {
        getString(com.ncautomation.commons.R.string.mobile) -> Phone.TYPE_MOBILE
        getString(com.ncautomation.commons.R.string.home) -> Phone.TYPE_HOME
        getString(com.ncautomation.commons.R.string.work) -> Phone.TYPE_WORK
        getString(com.ncautomation.commons.R.string.main_number) -> Phone.TYPE_MAIN
        getString(com.ncautomation.commons.R.string.work_fax) -> Phone.TYPE_FAX_WORK
        getString(com.ncautomation.commons.R.string.home_fax) -> Phone.TYPE_FAX_HOME
        getString(com.ncautomation.commons.R.string.pager) -> Phone.TYPE_PAGER
        getString(com.ncautomation.commons.R.string.other) -> Phone.TYPE_OTHER
        else -> Phone.TYPE_CUSTOM
    }

    private fun getEmailTypeId(value: String) = when (value) {
        getString(com.ncautomation.commons.R.string.home) -> CommonDataKinds.Email.TYPE_HOME
        getString(com.ncautomation.commons.R.string.work) -> CommonDataKinds.Email.TYPE_WORK
        getString(com.ncautomation.commons.R.string.mobile) -> CommonDataKinds.Email.TYPE_MOBILE
        getString(com.ncautomation.commons.R.string.other) -> CommonDataKinds.Email.TYPE_OTHER
        else -> CommonDataKinds.Email.TYPE_CUSTOM
    }

    private fun getEventTypeId(value: String) = when (value) {
        getString(com.ncautomation.commons.R.string.anniversary) -> CommonDataKinds.Event.TYPE_ANNIVERSARY
        getString(com.ncautomation.commons.R.string.birthday) -> CommonDataKinds.Event.TYPE_BIRTHDAY
        else -> CommonDataKinds.Event.TYPE_OTHER
    }

    private fun getAddressTypeId(value: String) = when (value) {
        getString(com.ncautomation.commons.R.string.home) -> StructuredPostal.TYPE_HOME
        getString(com.ncautomation.commons.R.string.work) -> StructuredPostal.TYPE_WORK
        getString(com.ncautomation.commons.R.string.other) -> StructuredPostal.TYPE_OTHER
