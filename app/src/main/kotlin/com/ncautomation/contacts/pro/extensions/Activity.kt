...
import com.ncautomation.contacts.pro.dialogs.ImportContactsDialog
import com.ncautomation.contacts.pro.helpers.DEFAULT_FILE_NAME
...
fun SimpleActivity.callContact(contact: Contact) {
    ...
    if (contact.phoneNumbers.isNotEmpty()) {
        ...
        toast(com.ncautomation.commons.R.string.no_phone_number_found)
    }
}
