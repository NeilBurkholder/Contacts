...
import com.ncautomation.commons.views.MyFloatingActionButton
...
import com.ncautomation.contacts.pro.activities.GroupContactsActivity
...
import com.ncautomation.contacts.pro.adapters.GroupsAdapter
...
import com.ncautomation.contacts.pro.helpers.AVOID_CHANGING_TEXT_TAG
import com.ncautomation.contacts.pro.helpers.AVOID_CHANGING_VISIBILITY_TAG
import com.ncautomation.contacts.pro.helpers.Config
import com.ncautomation.contacts.pro.helpers.GROUP
...
abstract class MyViewPagerFragment<Binding : MyViewPagerFragment.InnerBinding>(context: Context, attributeSet: AttributeSet) :
    ...
    fun setupFragment(activity: SimpleActivity) {
        ...
        if (this.activity == null) {
            ...
            when (this) {
                is ContactsFragment -> {
                    innerBinding.fragmentFab.contentDescription = activity.getString(com.ncautomation.commons.R.string.create_new_contact)
                }

                is FavoritesFragment -> {
                    innerBinding.fragmentPlaceholder.text = activity.getString(R.string.no_favorites)
                    innerBinding.fragmentPlaceholder2.text = activity.getString(com.ncautomation.commons.R.string.add_favorites)
                    innerBinding.fragmentFab.contentDescription = activity.getString(com.ncautomation.commons.R.string.add_favorites)
                }
        ...
        if (adapter is ContactsAdapter) {
            ...
            if (filtered.isEmpty() && this@MyViewPagerFragment is FavoritesFragment) {
                if (innerBinding.fragmentPlaceholder.tag != AVOID_CHANGING_TEXT_TAG) {
                    innerBinding.fragmentPlaceholder.text = activity?.getString(com.ncautomation.commons.R.string.no_contacts_found)
                }
            }
            ...
            if (filtered.isEmpty()) {
                innerBinding.fragmentPlaceholder.text = activity?.getString(com.ncautomation.commons.R.string.no_items_found)
            }
