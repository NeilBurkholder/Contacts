...
import com.ncautomation.contacts.pro.helpers.KEY_MAILTO
import com.ncautomation.contacts.pro.helpers.LOCATION_CONTACTS_TAB
import com.ncautomation.contacts.pro.helpers.LOCATION_FAVORITES_TAB
...
open class SimpleActivity : BaseSimpleActivity() {
    ...
    protected fun getTabIcon(position: Int): Drawable {
        val drawableId = when (position) {
            LOCATION_CONTACTS_TAB -> com.ncautomation.commons.R.drawable.ic_person_vector
            LOCATION_FAVORITES_TAB -> com.ncautomation.commons.R.drawable.ic_star_vector
            else -> com.ncautomation.commons.R.drawable.ic_people_vector
        }
    ...
    protected fun getTabLabel(position: Int): String {
        val stringId = when (position) {
            LOCATION_CONTACTS_TAB -> com.ncautomation.commons.R.string.contacts_tab
            LOCATION_FAVORITES_TAB -> com.ncautomation.commons.R.string.favorites_tab
            else -> com.ncautomation.commons.R.string.groups_tab
        }
