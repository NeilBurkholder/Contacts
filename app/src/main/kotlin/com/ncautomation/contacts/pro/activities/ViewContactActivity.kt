...
import com.ncautomation.contacts.pro.dialogs.ChooseSocialDialog
...
import com.ncautomation.contacts.pro.extensions.editContact
import com.ncautomation.contacts.pro.extensions.getPackageDrawable
import com.ncautomation.contacts.pro.extensions.startCallIntent
import com.ncautomation.contacts.pro.helpers.*

class ViewContactActivity : com.ncautomation.contacts.pro.activities.ContactActivity() {
    ...
    private fun gotContact() {
        ...
        if (contact!!.photoUri.isEmpty() && contact!!.photo == null) {
            ...
            val options = RequestOptions()
                .transform(FitCenter(), RoundedCorners(resources.getDimension(com.ncautomation.commons.R.dimen.normal_margin).toInt()))
        ...
        binding.contactSendSms.setOnLongClickListener { toast(com.ncautomation.commons.R.string.send_sms); true; }
        binding.contactStartCall.setOnLongClickListener { toast(R.string.call_contact); true; }
        binding.contactSendEmail.setOnLongClickListener { toast(com.ncautomation.commons.R.string.send_email); true; }
                            ...
                            try {
                                ...
                                handlePermission(PERMISSION_CALL_PHONE) { success ->
                                    if (success) {
                                        ...
                                        toast(com.ncautomation.commons.R.string.no_phone_call_permission)
                                    }
                                }
    ...
    private fun deleteContactFromAllSources() {
        ...
        val message = "${getString(com.ncautomation.commons.R.string.proceed_with_deletion)}$addition"
