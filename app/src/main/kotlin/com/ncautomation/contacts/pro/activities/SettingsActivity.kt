...
import com.ncautomation.contacts.pro.databinding.ActivitySettingsBinding
import com.ncautomation.contacts.pro.dialogs.ExportContactsDialog
import com.ncautomation.contacts.pro.dialogs.ManageAutoBackupsDialog
import com.ncautomation.contacts.pro.dialogs.ManageVisibleFieldsDialog
import com.ncautomation.contacts.pro.dialogs.ManageVisibleTabsDialog
import com.ncautomation.contacts.pro.extensions.*
import com.ncautomation.contacts.pro.helpers.VcfExporter
...
class SettingsActivity : SimpleActivity() {
    ...
    private fun setupDefaultTab() {
        ...
        binding.settingsDefaultTabHolder.setOnClickListener {
            val items = arrayListOf(
                RadioItem(TAB_CONTACTS, getString(com.ncautomation.commons.R.string.contacts_tab)),
                RadioItem(TAB_FAVORITES, getString(com.ncautomation.commons.R.string.favorites_tab)),
                RadioItem(TAB_GROUPS, getString(com.ncautomation.commons.R.string.groups_tab)),
                RadioItem(TAB_LAST_USED, getString(com.ncautomation.commons.R.string.last_used_tab))
            )
    ...
    private fun getDefaultTabText() = getString(
        when (baseConfig.defaultTab) {
            TAB_CONTACTS -> com.ncautomation.commons.R.string.contacts_tab
            TAB_FAVORITES -> com.ncautomation.commons.R.string.favorites_tab
            TAB_GROUPS -> com.ncautomation.commons.R.string.groups_tab
            else -> com.ncautomation.commons.R.string.last_used_tab
        }
    )
            ...
            ExportContactsDialog(this, config.lastExportPath, true) { file, ignoredContactSources ->
                ...
                Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
                    ...
                    try {
                        ...
                        toast(com.ncautomation.commons.R.string.no_app_found, Toast.LENGTH_LONG)
                    } catch (e: Exception) {
                        showErrorToast(e)
                    }
                }
        ...
        ContactsHelper(this).getContacts(true, false, ignoredContactSources) { contacts ->
            if (contacts.isEmpty()) {
                ...
                VcfExporter().exportContacts(this, outputStream, contacts, true) { result ->
                    toast(
                        when (result) {
                            VcfExporter.ExportResult.EXPORT_OK -> com.ncautomation.commons.R.string.exporting_successful
                            VcfExporter.ExportResult.EXPORT_PARTIAL -> com.ncautomation.commons.R.string.exporting_some_entries_failed
